...
@TeleOp(name="teleop_robot2024")
public class Robot_2024 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
     ...
     //   SampleGrabber = hardwareMap.servo.get("SG");
       ...
       double climbposition=0.3;
        ...
        double Specimenouttake_position = -1;
        ...
        while (!isStarted()) {
            telemetry.addData("Extension motor position", hangmotor.getCurrentPosition());
            telemetry.update();
            if(hangmotor.getCurrentPosition()<0.) {
                hangmotor.setPower(-hang_motor_power);
                int hang_target2 = (int) (hangmotor.getCurrentPosition() + (int) 1500 * ticks_per_rev / (360));
