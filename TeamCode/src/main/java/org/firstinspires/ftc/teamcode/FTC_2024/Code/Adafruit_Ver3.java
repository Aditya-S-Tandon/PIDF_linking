...
@Autonomous(name="Adafruit_Ver3")
public class Adafruit_Ver3 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        double sample_backward_target_two = 29;
        double sample_forward_target_one_init = 14;

        double rotation_angle = 0.57;//65 old//80 picked
        double rotation_angle_sample2 = 0.56;//70 picked and old
        ...
        */
         ...
         */
            ...
            while (Math.abs(imu.getRobotOrientationAsQuaternion().x) < Math.abs(rotation_angle) && opModeIsActive()) {
                ///turn anticlockwise
...
//Action to drop Sample
         ...
         */
            ...
            while (Math.abs(imu.getRobotOrientationAsQuaternion().x) < Math.abs(rotation_angle2/180) && opModeIsActive()) {
                ///turn anticlockwise
                FrontLeft.setPower(-0.45);
                BackLeft.setPower(-0.45);
                FrontRight.setPower(0.45);
         ...
         */
            ...
            while (Math.abs(imu.getRobotOrientationAsQuaternion().x) < Math.abs(rotation_angle_sample2) && opModeIsActive()) {
                ///turn anticlockwise
                FrontLeft.setPower(-0.45);
                BackLeft.setPower(-0.45);
                FrontRight.setPower(0.45);
 ...
 */
            ...
            while (Math.abs(imu.getRobotOrientationAsQuaternion().x) < Math.abs(rotation_angle3/180) && opModeIsActive()) {
                ///turn anticlockwise
                FrontLeft.setPower(-0.45);
                BackLeft.setPower(-0.45);
                FrontRight.setPower(0.45);
