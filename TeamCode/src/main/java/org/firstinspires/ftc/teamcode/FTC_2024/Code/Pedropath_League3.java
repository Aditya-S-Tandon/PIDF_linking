...
@Autonomous(name = "PedroPath_League3", group = "Examples")
public class Pedropath_League3 extends OpMode {
    ...
    private final Pose scorePose = new Pose(8, 133, Math.toRadians(-45));
    //private final Pose scorePose = new Pose(19, 111);

    /** Lowest (First) Sample from the Spike Mark */
    private final Pose pickup1Pose = new Pose(23, 127);
    /** Lowest (First) Sample from the Spike Mark */
    private final Pose intake1Pose = new Pose(10, 127);

    private final Pose score1Pose = new Pose(10, 139, Math.toRadians(-55));

    //private final Pose intake2Pose = new Pose(10, 140);

    /** Middle (Second) Sample from the Spike Mark */
    //private final Pose pickup2Pose = new Pose(29, 141);
    private final Pose intake2Pose = new Pose(10, 137);

    /** Middle (Second) Sample from the Spike Mark */
    private final Pose pickup2Pose = new Pose(21, 137);

    private final Pose score2Pose = new Pose(10, 143, Math.toRadians(-65));

    /** Highest (Third) Sample from the Spike Mark */
    private final Pose pickup3Pose = new Pose(25  , 130, Math.toRadians(100));
    private final Pose intake3Pose = new Pose(29  , 132, Math.toRadians(100));
    private final Pose score3Pose = new Pose(9, 138, Math.toRadians(-60));

    /** Park Pose for our robot, after we do all of the scoring. */
    private final Pose parkPose = new Pose(60, 100);
