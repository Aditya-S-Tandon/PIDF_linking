...
@Autonomous(name = "PedroPath_Auton_Ver3", group = "Examples")
public class Pedropath_Auton_Ver3 extends OpMode {
    ...
    private final Pose scorePose = new Pose(0, 134);
    ...
    private final Pose score1Pose = new Pose(9, 139, Math.toRadians(-45));
    ...
    private final Pose score2Pose = new Pose(10, 141, Math.toRadians(-60));
